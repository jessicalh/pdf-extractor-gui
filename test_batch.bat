...
echo ----------------------------------------
release\pdfextract.exe paper1_ai.pdf batch_paper1_text.txt -p 1-5 --config lmstudio_config.toml --summary batch_paper1_summary.txt --keywords batch_paper1_keywords.txt --verbose
...
echo ----------------------------------------
release\pdfextract.exe paper2_bert.pdf batch_paper2_text.txt -p 1-5 --config lmstudio_config.toml --summary batch_paper2_summary.txt --keywords batch_paper2_keywords.txt --verbose
